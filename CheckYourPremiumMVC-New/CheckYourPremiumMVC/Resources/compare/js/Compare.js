        ...
        if ($(".cmprBtn").hasClass("active")) {
           ...
           // $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '</div>');
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                /*appending to div*/
                $(".contentPop").append('<div class="col-xs-12 col-sm-12 col-md-3 compareItemParent prodetls">' + '<ul class="product">' + '<li class="compHeader"><img src="' + image + '" class="compareThumb"></li>' + '<li>' + premiumtotal + '</li>' + '<li>' + com1 + '</li>' + '<li>' + com2 + '<li>' + com3 + '</li>' + '<li>' + com4 + '</li>' + '<li>' + com5 + '</li>' + '<li>' + com6 + '</li>' + '<li>' + com7 + '</li>' + '<li>' + com8 + '</li>' + '<li>' + com9 + '</li>' + '<li>' + com10 + '</li>' + '<li>' + com11 + '</li>' + '<li>' + com12 + '</li>' + '<li>' + com13 + '</li>' + '<li>' + com14 + '</li>' + '<li>' + com15 + '</li>' + '<li>' + com16 + '</li>' + '<li>' + com17 + '</li>' + '<li>' + com18 + '</li><a class="AddD" href="#" onclick="NavigateDetail(' + premiumid + ')">' + button + '</a></li></ul>' + '</div>');

...
(function ($) {
    ...
    $(document).on('click', '.addToCompare', function () {
        ...
        var PlanName = $(this).parents('.selectProduct').attr('data-id');
      //  var Premiumtitle = $(this).parents('.selectProduct').attr('data-title');
        var inArray = $.inArray(PlanName, list);
        if (inArray < 0) {
            if (list.length > 2) {
                $("#WarningModal").show();
            ...
            if (list.length < 3) {
                ...
                $(".comparePan").append('<div id="' + PlanName + '" class="relPos titleMargin w3-margin-bottom"><div class="w3-white titleMargin"><a class="selectedItemCloseBtn w3-closebtn cursor">&times</a><img src="' + image + '" alt="image"/><p id="' + PlanName + '" class="titleMargin1">' + PlanName + '</p></div></div>');
            }
        } else {
            list.splice($.inArray(PlanName, list), 1);
            var prod = PlanName.replace(" ", "");
            $('#' + prod).remove();
            hideComparePanel();
    ...
    $(document).on('click', '.cmprBtn', function () {
        if ($(".cmprBtn").hasClass("active")) {
            ...
            $(".contentPop").append('<div class="col-md-3 dlwefjlerj">' + '<ul class="product">' + '<li class="compHeaderd"><p class="w3-display-middleg">Features</p></li><li>Company</li> ' + '<li>Plan Name </li>' + '<li>Minimum Entry Age</li>' + '<li>Maximum Entry Age</li>' + '<li>Cover Upto </li>' + '<li>Premium Payment Option</li>' + '<li>Payment Payment Mode</li>' + '<li>Minimum Sum Assured</li>' + '<li>Medical Test Required</li>' + '</div>');
           ...
           // $(".contentPop").append('<div class="w3-col s3 m3 l3 compareItemParent relPos">' + '</div>');
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                /*appending to div*/
           $(".contentPop").append('<div class="col-md-3 compareItemParent prodetls">' + '<ul class="product">' + '<li class="compHeader"><img src="' + image + '" class="compareThumb"></li>' + '<li>' + com1 + '</li>' + '<li>' + com2 + '<li>' + com3 + '</li>' + '<li>' + com4 + '</li>' + '<li>' + com5 + '</li>' + '<li>' + com6 + '</li>' + '<li>' + com7 + '</li>' + '<li>' + com8 + '</li>' + '<li>' + com9 + '</li><a class="AddD" href="#" onclick="NavigateDetail(' + premiumid + ')">' + button + '</a></li></ul>' + '</div>');

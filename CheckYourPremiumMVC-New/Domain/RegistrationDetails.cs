...
namespace Domain
{
    public class RegistrationDetails : Star_ProposalCreation
    {
       ...
       //For Health Proposal Requst
        ...
        public Insured insureds0 { get; set; }
        public Insured insureds1 { get; set; }
        public Insured insureds2 { get; set; }
        public Insured insureds3 { get; set; }
        [Required]
